...
int main()
{
	...
	cout<<"\n";
	vector<vector<int>> v;                                          
	vector<vector<float>> start_time(n,vector<float>(1000,0));      
	vector<vector<float>> end_time(n,vector<float>(1000,0));        
	vector<float> ans;                                              
	
	vector<int> speed;                                              
	vector<int> max_capacity;                                      
	vector<int> discharge;                                          
	vector<int> charging;                                           
	vector<int> initial_battery;                                    
	int count = 0;
	while(k--)
	{
